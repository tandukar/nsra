...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="relative flex flex-wrap items-center justify-between py-6 ">
        <div className="container  mx-auto flex flex-wrap items-center justify-between">
          <div>
            <a
              // className="text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase text-white"
              className="text-md font-bold leading-relaxed inline-block mr-8 py-2 whitespace-nowrap uppercase text-neutral-700"
              href="#pablo"
            >
              <img
          ...
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            <a
              // className="text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase text-white"
              className="text-md font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase text-neutral-700"
              href="#pablo"
            >
